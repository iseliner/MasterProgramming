...
'''
##This is the LDA transformer, which was intended o be a good method but was
...
rnn12 = GRU(100, return_sequences=False, dropout=0.2)(rnn11)
...
filepath = 'C:/Users/iseliner/Documents/programming/saved_models/GRUensemble_essay350_essay2hidden100_150epoch_min5_cbow200_patience2_speech150_min2_cbow100_2hidden60_lowerspeech_loweressay_ivec1hidden60.h5'
checkpoint = ModelCheckpoint(filepath, monitor='loss', verbose=1, 
                             save_best_only=True, mode='min')
earlystop = EarlyStopping(patience=2, monitor='loss', min_delta=0.01)
